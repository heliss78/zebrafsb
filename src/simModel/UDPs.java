...
class UDPs {
	...
	// GACOmment: clearly a bad translation from the CM. Name is not correct.
	// The contants should be defined in the Constants class.
	// And there is no searching of the RG.Officers/Q.ApprovalWiating entities
	// for determining the id of the
