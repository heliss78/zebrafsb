...
class RVPs {
	...
	protected RVPs(FSB model, Seeds sd) {
		...
		uOriginDM = new EmpiricalWalker(appLocationPDF, Empirical.NO_INTERPOLATION, new MersenneTwister(sd.seed1));
	...
	private final double[] appLocationPDF = { DIST1, DIST2, DIST3, DIST4, DIST5, DIST6 }; // for
																							// creating
																							// discrete
																							// PDF
	...
	protected double uDistrictProcessingTime() {
